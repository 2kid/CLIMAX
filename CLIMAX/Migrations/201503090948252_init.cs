namespace CLIMAX.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DiscountRate = c.Int(),
                        AmtDiscount = c.Double(),
                        AmtDue = c.Double(nullable: false),
                        ModeOfPayment = c.String(nullable: false),
                        AmtPayment = c.Double(nullable: false),
                        GiftCertificateAmt = c.Double(),
                ...
                c => new
                    {
                        ...
                        TreatmentPrice = c.Double(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Session_ChargeSlip", "TreatmentID", "dbo.Treatments");
            ...
            DropForeignKey("dbo.Procedures", "TreatmentID", "dbo.Treatments");
            ...
            DropForeignKey("dbo.MaterialLists", "TreatmentID", "dbo.Treatments");
            ...
            DropIndex("dbo.Session_ChargeSlip", new[] { "TreatmentID" });
            ...
            DropIndex("dbo.Procedures", new[] { "TreatmentID" });
            ...
            DropIndex("dbo.MaterialLists", new[] { "TreatmentID" });
