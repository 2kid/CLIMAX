...
namespace CLIMAX.Controllers
{
    public class ReportTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReportTypeID,reportType,reportDescription")] ReportType reportType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReportTypeID,reportType,reportDescription")] ReportType reportType)
        {
            if (ModelState.IsValid)
            {
